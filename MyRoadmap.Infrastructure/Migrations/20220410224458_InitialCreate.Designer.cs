...
namespace MyRoadmap.Infrastructure.Migrations
{
    ...
    [Migration("20220410224458_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyRoadmap.Domain.Entities.RoadmapItem", b =>
                {
                    ...
                    b.HasIndex("RoadmapId")
                        .HasDatabaseName("ix_roadmap_items_roadmap_id");
            ...
            modelBuilder.Entity("MyRoadmap.Domain.Entities.RoadmapItem", b =>
                {
                    b.HasOne("MyRoadmap.Domain.Entities.RoadmapItem", "LastRequiredItem")
                        .WithMany()
                        .HasForeignKey("LastRequiredItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_roadmap_items_roadmap_items_last_required_item_id");

                    b.HasOne("MyRoadmap.Domain.Entities.Roadmap", null)
                        .WithMany("RoadmapItems")
                        .HasForeignKey("RoadmapId")
                        .HasConstraintName("fk_roadmap_items_roadmaps_roadmap_id");
